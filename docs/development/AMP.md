...
| **Amp-Principal** | **Amp-p** | Technical architecture, code quality | Go engineering, system design, code standards | How to build, technical standards |
...
Amp-p, please provide technical review of [code/architecture].
```
...
# Amp-p: Senior Technical Architect
...
Amp-p, please assess technical soundness and provide recommendations.
```
...
Amp-p, please provide quality assessment with improvement plan.
```
...
2. **Amp-p** ensures technical quality of strategic implementation
...
- **Strategic decisions requiring technical feasibility** → Consult Amp-p
- **Cross-team coordination** → Amp-s leadership with Amp-p technical input

### Review Coordination
- **Major Features**: Strategic review (Amp-s) → Technical review (Amp-p) → Implementation
- **Architecture Changes**: Technical review (Amp-p) with strategic alignment check (Amp-s)
- **Business Impact**: Strategic assessment (Amp-s) with technical feasibility (Amp-p)

## 🎯 Clear Role Boundaries

| Aspect | Amp-s (Strategic) | Amp-p (Technical) |
|--------|------------------|-------------------|
...
- **Amp-p**: Reviews technical implementation quality and architectural decisions

### AC (Augment Code) Coordination  
- **Amp-s**: Guides user experience strategy and feature prioritization
- **Amp-p**: Ensures technical quality of user-facing implementations

### Cross-Team Alignment
- **Strategic Alignment**: Amp-s ensures all teams work toward unified strategic goals
- **Technical Consistency**: Amp-p ensures consistent technical standards across teams
...
**Technical Leadership**: Amp-p for code quality and architecture excellence  
